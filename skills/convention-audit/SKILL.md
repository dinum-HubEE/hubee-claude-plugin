...
- **Audités** : `principles`, `choosing-a-pattern`, `models`, `controllers`, `ruby-style`, `interactors`, `rspec-conventions`, `test-strategy`, `frontend-rails`, `api-client`, `hotwire`, `authentication`, `security`, `performance`.
