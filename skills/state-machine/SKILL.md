---
name: state-machine
description: "State machines HubEE avec la gem AASM : modéliser le cycle de vie et les transitions d'états d'une ressource (statuts, événements, guards). À utiliser dès qu'un modèle a un champ statut avec des transitions contraintes. Pour le choix du pattern, voir le routeur de la skill rails-patterns."
globs:
  - "app/models/**/*.rb"
---
